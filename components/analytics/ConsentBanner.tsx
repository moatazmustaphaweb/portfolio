...
export function ConsentBanner({
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-container flex-wrap items-center gap-4 px-gutter py-4">
        <p className="min-w-measure-lead flex-1 text-meta text-fg-body">{message}</p>
        ...
        */}
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="h-control-h min-w-control rounded-control border border-strong px-4 text-ui text-fg transition-colors hover:border-fg"
          >
            {decline}
          </button>
          <button
