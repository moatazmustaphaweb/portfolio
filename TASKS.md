...
- [ ] 🔴 Native Arabic review — `docs/ui-strings-review.md` (52 strings, generated by `npm run export:ui-strings`). Sent 2026-08-11
...
- [ ] Arabic UI strings corrected per `docs/ui-strings-review.md`, database updated **and** `0003_seed_site_chrome.sql` updated to match
